#!/usr/bin/env python3
"""Display 0. Regex-ing: filter_datum
...
def filter_datum(fields: List[str], redaction: str, message: str,
                 separator: str) -> str:
    """ Descript: Regex-ing - Write a function called filter_datum that
...
def main():
    """
        Descript: Implement a main function that takes no arguments and
                     returns nothing.
